...
Ejecutar el ciclo de vida completo de infraestructura usando Terraform CLI: inicialización, planificación, aplicación, consulta de salidas y destrucción. Se usará el archivo `main.tf` existente con recursos definidos y variables locales, organizados bajo estándares para ambientes financieros de desarrollo, pruebas y limpieza controlada.
...
- **Paso 3.** Aplica el siguiente comando en la terminal.
  ...
  ![terraimg26](../images/lab6/fin/3.png)
  
  ---
  
  ![terraimg27](../images/lab6/fin/1.png)
...
- **Paso 6.** Verifica cómo cambian los nombres para cada entorno controlado.
...
- **Paso 9.** Cuanto hayas terminado de revisar el `apply`, confirma con **`yes`** cuando Terraform lo solicite.
  ...
  **NOTA:** Tambien puedes usar el comando `terraform apply -auto-approve` es util cuando quieres omitir la confirmacion `yes`.
...
- **Paso 11.** Revisa los `outputs` generados por el `apply`.
  ...
  ![terraimg31](../images/lab6/fin/2.png)

- **Paso 12.** Ahora copia el valor del output llamado `aci_fqdn` y pegalo en una pestaña de tu navegador.

  ![terraimg32](../images/lab6/fin/4.png)
  
  ---
  
  ![terraimg33](../images/lab6/fin/5.png)
...
- **Paso 13.** Aplica el siguiente comando en la terminal.
  ...
  ![terraimg34](../images/lab6/fin/6.png)
...
- **Paso 14.** Aplica el siguiente comando en la terminal.
  ...
  ![terraimg35](../images/lab6/fin/7.png)

> **TAREA FINALIZADA**

**Resultado esperado:** Se mostrarán los nombres de los recursos y la dirección DNS del contenedor creado. Esta información es útil para integrarse con sistemas de BI o automatizaciones internas.

---

### Tarea 5. Destruir los recursos (opcional)

Este paso elimina toda la infraestructura creada. Es útil en ambientes de pruebas o limpieza post-validación.

**IMPORTANTE:** Este paso es parte del ciclo de vida, sin embargo no se eliminaran todavia los recursos. 

#### Tarea 5.1. Ejecutar `terraform destroy`

- **Paso 5.** Aplica el siguiente comando en la terminal.
